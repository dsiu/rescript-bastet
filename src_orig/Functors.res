...
module ResultF = {
  module Int = {
    module Functor = Result.Functor({
      type t = int
    })

    module Apply = Result.Apply({
      type t = int
    })

    module Applicative = Result.Applicative({
      type t = int
    })

    module Monad = Result.Monad({
      type t = int
    })

    module Extend = Result.Extend({
      type t = int
    })

    module Alt = Result.Alt({
      type t = int
    })

    module Foldable = Result.Foldable({
      type t = int
    })
...
module FunctionF = {
  module Int = {
    module Functor = Function.Functor({
      type t = int
    })
  }
