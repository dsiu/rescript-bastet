...
module Toggle = {
  ...
  module Distributive_Lattice: DISTRIBUTIVE_LATTICE with type t = toggle = {
    include Lattice
  }

  module Bounded_Distributive_Lattice: BOUNDED_DISTRIBUTIVE_LATTICE with type t = toggle = {
  ...
  module Involutive_Heyting_Algebra: INVOLUTIVE_HEYTING_ALGEBRA with type t = toggle = {
    include Heyting_Algebra
  }

  module Boolean_Algebra: BOOLEAN_ALGEBRA with type t = toggle = {
    include Heyting_Algebra
  }
...
describe("Result", () => {
  describe("Medial Magma", () => {
    module Medial_Magma = Result.Medial_Magma(
      {
        type t = string
      },
  ...
  describe("Semigroup", () => {
    module Semigroup = Result.Semigroup(
      {
        type t = string
      },
  ...
  describe("Join_Semilattice", () => {
    module V = Verify.Join_Semilattice(
      Result.Many_Valued_Logic.Join_Semilattice(Bool.Join_Semilattice, Toggle.Join_Semilattice),
    )
    property3(
      "should satisfy associativity",
  ...
  describe("Meet_Semilattice", () => {
    module V = Verify.Meet_Semilattice(
      Result.Many_Valued_Logic.Meet_Semilattice(Bool.Meet_Semilattice, Toggle.Meet_Semilattice),
    )
    property3(
      "should satisfy associativity",
      arb_result(arb_bool, Toggle.arb_toggle),
  ...
  describe("Bounded_Join_Semilattice", () => {
    module V = Verify.Bounded_Join_Semilattice(
      Result.Many_Valued_Logic.Bounded_Join_Semilattice(
        ...
        Toggle.Bounded_Join_Semilattice,
      ),
    )
  ...
  describe("Bounded_Meet_Semilattice", () => {
    module V = Verify.Bounded_Meet_Semilattice(
      Result.Many_Valued_Logic.Bounded_Meet_Semilattice(
        ...
        Toggle.Bounded_Meet_Semilattice,
      ),
    )
    property1("should satisfy identity", arb_result(arb_bool, Toggle.arb_toggle), V.identity)
  })
  describe("Lattice", () => {
    module V = Verify.Lattice(Result.Many_Valued_Logic.Lattice(Bool.Lattice, Toggle.Lattice))
    property2(
  ...
  describe("Bounded_Distributive_Lattice", () => {
    module V = Verify.Bounded_Distributive_Lattice(
      Result.Many_Valued_Logic.Bounded_Distributive_Lattice(
        ...
        Toggle.Bounded_Distributive_Lattice,
      ),
    )
    property3(
      "should satisfy distributivity",
  ...
  describe("Heyting_Algebra", () => {
    module V = Verify.Heyting_Algebra(
      Result.Many_Valued_Logic.Heyting_Algebra(Bool.Heyting_Algebra, Toggle.Heyting_Algebra),
    )
    property1(
  ...
  describe("Involutive_Heyting_Algebra", () => {
    module V = Verify.Involutive_Heyting_Algebra(
      Result.Many_Valued_Logic.Involutive_Heyting_Algebra(
        ...
        Toggle.Involutive_Heyting_Algebra,
      ),
    )
  ...
  describe("Boolean_Algebra", () => {
    module V = Verify.Compare.Boolean_Algebra(
      Result.Many_Valued_Logic.Boolean_Algebra(Bool.Boolean_Algebra, Toggle.Boolean_Algebra),
      Result.Many_Valued_Logic.Quasireflexive_Eq(Bool.Boolean_Algebra, Toggle.Boolean_Algebra),
    )
